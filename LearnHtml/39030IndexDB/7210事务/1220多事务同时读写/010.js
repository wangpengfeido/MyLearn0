...
function doSth() {
  ...
  request2a = objectStore2.get('1');
  request2a.onsuccess = (event) => {
    console.log('2a success', event);
    const data = request2a.result;
    data.b.push('y');
    request2b = objectStore2.put(data);
    request2b.onsuccess = (event) => {
      console.log('2b success', event);
    };
    request2b.onerror = (event) => {
      console.log('2b error', event);
    };
  };
  request2a.onerror = (event) => {
    console.log('2a error', event);
  };
